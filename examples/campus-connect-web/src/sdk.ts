...
export const EVENTS = [
  {
    id: 1,
    title: "Annual Tech Fest — TechSpark 2025",
    date: "Feb 15-17",
  ...
  {
    id: 3,
    title: "Cultural Night — Rang Tarang",
    date: "Mar 1",
  ...
  {
    id: 4,
    title: "Industry Visit: Google Bangalore",
    date: "Mar 10",
    venue: "Depart from Gate 1",
    type: "Industrial",
    emoji: "🏢",
    color: "#e8f5e9",
    spots: 45,
...
export const NOTIFICATIONS = [
  {
    ...
    body: "Submit linked list implementation by 11:59 PM",
    type: "deadline",
    time: "2 hours ago",
    read: false,
  },
  {
    ...
    body: "Semester 6 fees of ₹45,000 due by Jan 31",
    type: "payment",
    time: "5 hours ago",
    read: false,
  },
  {
    id: 3,
    title: "Class Cancelled: OS Lab",
    body: "Prof. Patel is on leave. Class rescheduled to Friday",
    type: "class",
    time: "Yesterday",
    read: true,
  },
  {
    id: 4,
    title: "TechSpark Registration Open",
    body: "Register for 10+ events. Early bird until Feb 1",
    type: "event",
    time: "Yesterday",
    read: true,
  },
  {
    ...
    body: 'Return "CLRS Introduction to Algorithms" by Jan 28',
    type: "general",
    time: "2 days ago",
    read: true,
  },
  {
    ...
    body: "End-semester exams start March 25. Check timetable.",
    type: "general",
    time: "3 days ago",
    read: true,
  },
